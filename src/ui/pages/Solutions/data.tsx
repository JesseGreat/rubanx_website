...
export const solutions = [
  ...
  },
  {
    ...
    status: "Development",
    problem:
      "In rapidly growing cities, finding decent, affordable housing near the city center is a tough challenge for most people. Urban dwellers—especially young professionals, civil servants, and students—are often pushed to the outskirts, enduring long commutes, inflated agent fees, and unreliable housing information. The lack of transparency and trusted access creates unnecessary stress and limits opportunity.",
    solution:
      "The Affordable Housing Tool is a digital platform that makes it easy to discover verified and budget-friendly housing options close to work or city centers. Users can filter by budget, location, and commute time, explore listings virtually, and even connect directly with landlords—eliminating the need for middlemen and reducing the risk of fraud or inflated fees.",
    features: [
  ...
  },
  {
    ...
    status: "Development",
    problem:
      "In many African cities, accessing basic public services like healthcare, education, and utilities can be stressful and inefficient. Residents often deal with long queues, multiple physical visits, poor communication, and fragmented service systems that waste time and cause frustration.",
    solution:
      "The Urban Resource Platform is an all-in-one digital hub that streamlines how residents connect with essential services. From booking hospital appointments to accessing educational resources or paying utility bills, the platform brings everything under one roof—reducing time, improving service delivery, and enhancing city life for everyone.",
    features: [
