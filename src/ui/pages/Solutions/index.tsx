    ...
    <AppLayout>
      ...
      <section className="relative py-32 flex items-center justify-center">
        <div
          ...
          style={{
            backgroundImage: `linear-gradient(rgba(0,0,0,0.6), rgba(0,0,0,0.6)), url('https://cdn.pixabay.com/photo/2022/06/28/09/07/question-7289231_1280.png')`,
            backgroundSize: "cover",
            backgroundPosition: "center",
          }}
        />

        <div className="container pt-[100px] px-4 text-center relative z-10 text-white">
          <motion.div
          ...
          >
            ...
            <p className="text-xl md:text-2xl  max-w-3xl mx-auto">
              At Zypa Tech, we leverage technology to tackle Afric&apos;s most
        ...
        <div className="container mx-auto px-4">
          ...
          >
            <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
              From seamless transportation to affordable housing and integrated
              city services, our solutions are designed to build smarter, more
              connected, and sustainable urban communities for a stronger
              Africa.
            </p>
          </motion.div>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl mb-8 max-w-2xl mx-auto opacity-90">
              Join thousands of users across Africa who are already experiencing
              the future of urban living through our innovative solutions.
            </p>
