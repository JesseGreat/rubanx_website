...
export const ImpactPage: React.FC = () => {
  const partnerTypes = [
    {
      title: 'NGOs',
      description: 'Collaborate on community projects to maximize social impact and reach underserved populations.',
      icon: <Heart className="text-orange-500" size={32} />,
      benefits: ['Community outreach', 'Social programs', 'Grassroots initiatives']
    },
    {
      title: 'Investors',
      description: 'Fuel our growth and expand our innovative solutions across African cities for sustainable returns.',
      icon: <DollarSign className="text-orange-500" size={32} />,
      benefits: ['Scalable ROI', 'Market expansion', 'Innovation funding']
    },
    {
      title: 'Government Bodies',
      description: 'Implement smart city initiatives and improve essential public services for citizens.',
    ...
    },
    {
      ...
      description: 'Integrate WovenByte solutions into future city designs and sustainable master plans.',
      icon: <MapPin className="text-orange-500" size={32} />,
      benefits: ['Strategic planning', 'Future-ready cities', 'Sustainable design']
    }
  ];
  ...
  const sustainabilityGoals = [
    {
      ...
      description: "Optimize transport routes to reduce emissions by 25% by 2026",
      progress: 65,
      icon: Globe
    },
    {
      title: "Digital Inclusion",
      description: "Ensure 80% of urban populations have access to our platforms",
      progress: 45,
      icon: Users
    },
    {
    ...
    <AppLayout>
      ...
      <Section>
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-8">Urban Stats & Growth Projections</h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Understanding the scale of urban challenges and opportunities across Africa.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <Card className="overflow-hidden">
            <div className="p-8">
              <h3 className="text-2xl font-bold text-gray-900 mb-4">African Urban Population Growth</h3>
              <p className="text-gray-600 mb-6">Projected population growth in African urban centers by 2050 (in millions).</p>
              ...
              <div className="relative h-64 bg-gradient-to-t from-orange-50 to-blue-50 rounded-lg flex items-end justify-center p-6">
                <div className="flex items-end space-x-8">
                  <div className="text-center">
                    ...
                    <span className="text-sm text-gray-600 mt-2 block font-medium">2020</span>
                  </div>
                  ...
                  <div className="text-center">
                    <div className="bg-orange-500 w-16 h-48 rounded-t-lg shadow-lg flex items-end justify-center pb-2">
                      <span className="text-white font-bold text-sm">2.2B+</span>
                    </div>
                    <span className="text-sm text-gray-600 mt-2 block font-medium">2050</span>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-6 p-4 bg-orange-50 rounded-lg">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-lg font-bold text-orange-600">+300%</span>
                </div>
              </div>
            </div>
          </Card>
          ...
          <Card className="overflow-hidden">
            <div className="p-8">
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Economic Impact of Traffic Congestion</h3>
              <p className="text-gray-600 mb-6">Annual economic losses due to traffic inefficiencies across major African cities (in billions USD).</p>
              ...
              <div className="relative h-64 bg-gray-50 rounded-lg flex items-end justify-between p-4">
                {[
                  ...
                  <div key={index} className="text-center flex-1">
                    <div 
                      className={`${index === 5 ? 'bg-orange-500' : 'bg-blue-500'} mx-1 rounded-t transition-all hover:opacity-80 flex items-end justify-center pb-1`}
                      style={{ height: `${item.height * 12}px` }}
                    >
                      <span className="text-white text-xs font-bold transform -rotate-90">{item.value}</span>
                    </div>
                    <span className="text-xs text-gray-600 mt-1 block">{item.city}</span>
                  </div>
                ))}
              </div>
              ...
              <div className="mt-6 p-4 bg-red-50 rounded-lg">
                <div className="flex items-center justify-between">
                  <span className="text-sm font-medium text-gray-700">Total Annual Loss</span>
                  <span className="text-lg font-bold text-red-600">$35B+ USD</span>
                </div>
              </div>
            </div>
          </Card>
      ...
      <Section background="gray">
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">Sustainability Goals</h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Our commitment to building sustainable, resilient cities for future generations.
          </p>
        </motion.div>
      ...
      <Section>
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            WovenByte seeks collaborative alliances with organizations that share our vision for innovative urban development and sustainable growth.
          </p>
        </motion.div>
